...
struct NetCaloriesCardView: View {
    let title: String
...
#Preview {
    NetCaloriesCardView(title: "Net calories today", netCalories: 1100, intakeCalories: 1500, burntCalories: 400, calorieTarget: 1500, showAddIntake: .constant(false))
}
